...
const Patents = () => {
  ...
  return (
    <section id="patents" className="relative py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-5 mx-auto max-w-6xl bg-gradient-to-r from-blue-400 to-blue-800 rounded-lg mb-8 shadow-md">
      ...
      <div className="carousel-container flex flex-wrap sm:flex-nowrap justify-center md:justify-start overflow-x-auto snap-x gap-3 sm:gap-4 md:gap-5 p-4 sm:p-5 md:p-6 rounded-xl bg-dark-surface-2 shadow-md scrollbar-thin scrollbar-thumb-primary-color scrollbar-track-dark-surface">
        {patents.map((patent, index) => (
          ...
          >
            <div className="text-3xl sm:text-4xl md:text-5xl mb-2 sm:mb-3 md:mb-4 text-secondary-color">{patent.icon}</div>
