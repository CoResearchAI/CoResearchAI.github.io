...
const Hero = () => {
  return (
    <section id="home" className="relative py-32 px-5 text-center">
      ...
      <div className="features flex flex-wrap justify-around mt-12">
        <FeatureCard
          icon={<FaUsers />}
...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div className="feature flex-1 min-w-[280px] p-6 m-4 rounded-xl bg-dark-surface shadow-md transition-all duration-300 relative overflow-hidden text-center border border-white border-opacity-5 hover:transform hover:-translate-y-1 hover:shadow-lg hover:border-accent-color">
